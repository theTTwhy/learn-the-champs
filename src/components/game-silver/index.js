...
class GameSilver extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            randomSpellDescription: null,
            randomSpellImageURL: null,
            randomSpellNameFalse: null,
            randomSpellDescriptionFalse: null,
            randomSpellImageURLFalse: null,
        };
    }

    componentDidMount(){
        // set title on page
        document.title = "Learn the Champs | Silver";

        //Fetch all Champions from ddragon with basic info (no abilities)
        axios.get(`https://ddragon.leagueoflegends.com/cdn/11.9.1/data/en_US/champion.json`)
            .then(res => {
    ...
    generateNewQuestion() {
        ...
        axios.get(`https://ddragon.leagueoflegends.com/cdn/11.9.1/data/en_US/champion/`+ champion.id +`.json`)
            .then(res => {
                ...
                let randomSpellImageURL = "https://www.mobafire.com/images/ability/" + champion.name.replaceAll(" ","-").replaceAll("'","").replaceAll("-/-","-") + "-" + randomSpellName.replaceAll(" ","-").replaceAll("'","").replaceAll("-/-","-").replaceAll("the-","-") + ".png";

                this.setState({
                    randomSpellName: randomSpellName,
                    randomSpellDescription: randomSpellDescription,
                    randomSpellImageURL: randomSpellImageURL.toLowerCase(),
                })
            });

        axios.get(`https://ddragon.leagueoflegends.com/cdn/11.9.1/data/en_US/champion/`+ championFalse.id +`.json`)
            .then(res => {
                let key = Object.keys(res.data.data)[0];
                let championsSpells = res.data.data[key].spells;
                let randomSpellNumber = Math.floor(Math.random() * 4);
                ...
                let randomSpellImageURL = "https://www.mobafire.com/images/ability/" + championFalse.name.replaceAll(" ","-").replaceAll("'","").replaceAll("-/-","-") + "-" + randomSpellName.replaceAll(" ","-").replaceAll("'","").replaceAll("-/-","-").replaceAll("the-","-") + ".png";

                this.setState({
                    randomSpellNameFalse: randomSpellName,
                    randomSpellDescriptionFalse: randomSpellDescription,
                    randomSpellImageURLFalse: randomSpellImageURL.toLowerCase(),
                })
            });
                    ...
                    <>
                        <div className="col-12 text-center mt-5 mb-5">
                            <h1 className="mt-5 mb-5">
                                Explanation Learn the Champions Silver
                            </h1>
                            <p>
                        ...
                        <>
                            <div className="col-12 text-center mt-5 mb-5">
                                ...
                                <div className="image-wrapper">
                                    <img src={ this.state.championImageURL } alt="Champion" className="img-fluid champion-image"/>
                                ...
                                <div className="row">
                                    <div className={"col-12 col-md-6 text-center order-" + randomOrder1 } onClick={this.checkAnswer.bind(this, true)}>
                                        <div className="spell-details">
                                            ...
                                            <p>
                                                { this.state.randomSpellDescription }
                                            </p>
                                        </div>
                                    </div>
                                    <div className={"col-12 col-md-6 mt-5 mt-md-0 text-center order-" + randomOrder2 } onClick={this.checkAnswer.bind(this, false)}>
                                        <div className="spell-details">
                                            ...
                                            <p>
                                                { this.state.randomSpellDescriptionFalse }
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                { this.state.showResults === false ? //show result single or total
                                    <>
                                        ...
                                        { this.state.resultThis === "False" ?
                                            <>
                                                <p className="mb-5">
                                                    You guessed incorrectly, view below what the 2 champions belong to which spell!
                                                </p>
                                            </>
                                            : ""
                                        }
                                        <div className="row">
                                            <div className="col-12 col-md-6">
                                                ...
                                                <div className="spell-details mt-4">
